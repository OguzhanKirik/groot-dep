...
def object_obs(
    ...
    left_eef_idx = env.scene["robot"].data.body_names.index("wristRollLeft")
    right_eef_idx = env.scene["robot"].data.body_names.index("wristRollRight")
...
def get_head_state(
    ...
    head_joint_names = ["neckPitch", "neckYaw"]
